...
import com.restaurant.teditiansukma.model.LoginResponse;
...
public class LoginActivity extends AppCompatActivity {
        ...
        AndroidNetworking.post(LOGIN)
                ...
                .getAsObject(LoginResponse.class, new ParsedRequestListener() {
                    ...
                    public void onResponse(Object response) {
                        if (response instanceof LoginResponse) {
                            ...
                            if (res.getStatus().equals("success")) {
                                ...
                                Toast.makeText(LoginActivity.this, "Email atau Username Salah",
                    ...
                    public void onError(ANError anError) {
                        Toast.makeText(LoginActivity.this, "Terjadi kesalahan API",
                                Toast.LENGTH_SHORT).show();
    ...
    private void initBinding() {btnLogin = findViewById(R.id.btn_login);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(email.getText().toString().equals("")){
                    Toast.makeText(LoginActivity.this, "Email Tidak boleh kosong",
                            Toast.LENGTH_SHORT).show();
                }else if(password.getText().toString().equals("")){
                    Toast.makeText(LoginActivity.this, "Password Tidak boleh kosong",
                            Toast.LENGTH_SHORT).show();}else {login();
                }
            }
        });
