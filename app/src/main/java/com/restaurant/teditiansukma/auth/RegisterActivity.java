    ...
    btnRegister.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if(email.getText().toString().equals("")){
                ...
                Toast.makeText(RegisterActivity.this, "Nama harus diisi",
    ...
    AndroidNetworking.post(REGISTER)
            ...
            .getAsObject(RegisterResponse.class, new ParsedRequestListener() {
                ...
                public void onResponse(Object response) {
                    if (response instanceof RegisterResponse) {
                        ...
                        if (res.getStatus().equals("success")) {
                            ...
                            Toast.makeText(RegisterActivity.this, "Username sudah digunakan",
                                    Toast.LENGTH_SHORT).show();
                        }
                ...
                public void onError(ANError anError) {
                    Toast.makeText(RegisterActivity.this, "Terjadi kesalahan API",
                            Toast.LENGTH_SHORT).show();
                    DialogUtils.closeDialog();
                }
            });
