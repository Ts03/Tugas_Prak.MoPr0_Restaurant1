...
import com.restaurant.teditiansukma.model.RegisterResponse;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    Button changeProfil;
    ProgressDialog progressDialog;String nama="";
                    ...
                    public void onClick(View v) {
                        if (name.getText().toString().isEmpty()) {
                            Toast.makeText(ChangePasswordActivity.this,
                                    "nama harus diisi", Toast.LENGTH_SHORT).show();
                        } else if (oldPass.getText().toString().isEmpty()) {
                            Toast.makeText(ChangePasswordActivity.this,
                                    "password lama harus diisi", Toast.LENGTH_SHORT).show();
                        } else if (newPass.getText().toString().isEmpty()) {
                            Toast.makeText(ChangePasswordActivity.this,
                                    "password baru harus diisi", Toast.LENGTH_SHORT).show();
                        } else {
                            updateUser();
                        }
                    }
    ...
    public void updateUser() {
        ...
        AndroidNetworking.post(Constans.UPDATE_PROFILE_USER+"/"+session
                .getUserId()).addBodyParameter("nama", name.getText()
                .toString()).addBodyParameter("old_password", oldPass
                .getText().toString()).addBodyParameter("new_password", newPass
                .getText().toString())
                .build().getAsObject(RegisterResponse.class, new ParsedRequestListener() {
                    ...
                    @Override public void onError(ANError anError) {
                        ...
                        Toast.makeText(ChangePasswordActivity.this,
                                "Terjadi kesalahan API : "+anError.getCause()
